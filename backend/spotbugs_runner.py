...
BUILD_TIMEOUT = 120  # seconds for Maven/Gradle compile
SPOTBUGS_TIMEOUT = 90  # seconds for SpotBugs analysis
TOTAL_TIMEOUT = 180  # hard cap for the whole SpotBugs stage
